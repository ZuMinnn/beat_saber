...
const GameScene: React.FC<GameSceneProps> = ({ 
  ...
  return (
    <>
      ...
      {/* Brighter Lighting for Pop look */}
      ...
      {/* Decorative distant mountains / wireframes */}
      <group position={[0, 0, -40]}>
         <mesh position={[-15, 5, 0]} rotation={[0, 0, Math.PI / 4]}>
             <torusGeometry args={[8, 0.2, 8, 4]} />
             <meshBasicMaterial color={saberConfig.leftColor} wireframe toneMapped={false} />
         </mesh>
         <mesh position={[15, 8, 0]} rotation={[0, Math.PI/4, 0]}>
             <icosahedronGeometry args={[4, 0]} />
             <meshBasicMaterial color={saberConfig.rightColor} wireframe toneMapped={false} />
         </mesh>
      </group>
