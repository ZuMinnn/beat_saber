...
const WebcamPreview: React.FC<WebcamPreviewProps> = ({ videoRef, resultsRef, isCameraReady, leftColor, rightColor }) => {
    ...
    return (
        <div className="fixed bottom-6 right-6 w-48 h-36 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] z-50 pointer-events-none rotate-2">
             <div className="absolute -top-3 -left-3 bg-[#FAFF00] text-black px-2 border-2 border-black font-bold text-xs">
                CAM_FEED
            </div>
